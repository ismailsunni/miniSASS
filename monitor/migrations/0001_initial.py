...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'archived_observations', (
            ...
            ('obs_date', self.gf('django.db.models.fields.DateField')()),
            ('flag', self.gf('django.db.models.fields.CharField')(default='dirty', max_length=5)),
            ('water_clarity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=1, blank=True)),
            ('water_temp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=1, blank=True)),
            ('ph', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True)),
            ('diss_oxygen', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('diss_oxygen_unit', self.gf('django.db.models.fields.CharField')(default='mgl', max_length=8, null=True, blank=True)),
            ('elec_cond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('elec_cond_unit', self.gf('django.db.models.fields.CharField')(default='mSm', max_length=8, null=True, blank=True)),
        ))
